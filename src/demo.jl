...
function main()
    observer = Point3f(15f0, -5f0, 0f0)

    geometry1 = Box((-0.5f0, 0f0, 0f0), (0.5f0, 1f0, 10f0)) |>
                boundary |>
    ...
    if false
        ...
        viz(fig[1, 2], Sphere((0f0, 0f0), 1.0f0), color=:red, aspect=1)
        viz!(fig[1, 2], Sphere((0f0, 0f0), 0.01f0))
